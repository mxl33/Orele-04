    ...
    (() => {
        ...
        function swiperMode() {
            ...
            if (mobile.matches) {
                if (!init) {
                    init = true;
                    swiper = new swiper_core_Swiper(".explore-blog__slider", {
                        observer: true,
                        observeParents: true,
                        slidesPerView: 1.2,
                        spaceBetween: 20,
                    ...
                    swiper = new swiper_core_Swiper(".product__slider", {
                        modules: [ Navigation ],
                        observer: true,
                        observeParents: true,
                        slidesPerView: 1,
                    ...
                    swiper = new swiper_core_Swiper(".recommended__slider", {
                        observer: true,
                        observeParents: true,
                        slidesPerView: 1.7,
                        spaceBetween: 20,
        ...
        if (dropDownTriggers) dropDownTriggers.forEach((dropDownTrigger => {
            dropDownTrigger.addEventListener("click", (function(e) {
                if (e.target.closest("[data-dropdown-trigger]")) {
                    const dropDown = document.getElementById(dropDownTrigger.getAttribute("aria-controls"));
        ...
        window.addEventListener("scroll", (function(e) {
            ...
            if (window.scrollY == 0) header.classList.remove("header--short");
        }));
    })();
})();